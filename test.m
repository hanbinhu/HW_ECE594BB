...
ip_TT_CP_tn = ip_TT_CP_TN(Tensor_X_TT,lambda_Y_CP,K_Y_CP);
...
ip_TT_HOSVD_tn =ip_TT_Tucker_TN(Tensor_X_TT,G_Y_HOSVD,K_Y_HOSVD);
...
ip_TT_HOOI_tn = ip_TT_Tucker_TN(Tensor_X_TT,G_Y_HOOI,K_Y_HOOI);
fprintf(['Inner product (TN) by Tensor Train decomposition and Tucker '...
    'decompostion (HOOI): %.4f, absolute error: %.4f, relative error: '...
